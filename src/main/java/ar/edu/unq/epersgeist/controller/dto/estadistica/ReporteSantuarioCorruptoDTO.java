...
public record ReporteSantuarioCorruptoDTO(String nombreDelSantuario, MediumDTO mediumConMasDemonios,
                                          Integer cantTotalDemonios, Integer cantDemoniosLibres) {
